        ...
        <IfAnyGranted expected={['Admin']} actual={this.props.userProps.user.role} unauthorized={<ErrorPage />}>    
            <div id="page-wrapper">
                <div className="container-fluid">
                    <PageHeader title={constants.APPLICATION_ADMINISTRATION_PAGE} />
                    <div className="white-box">
                        <form>
                            <div className="form-group row">
                                <label className="col-sm-2 col-form-label" style={{ fontSize: '16px', marginTop: '25px', marginRight: '-25px' }}>Open Enrollment:</label>
                    ...
                    <div className="white-box">
                        <div className="form-group row">
                            <label className="col-sm-12 col-form-label" style={{ fontSize: '16px' }}>Copy Waivers</label>
                            <br />
                            <ul>
