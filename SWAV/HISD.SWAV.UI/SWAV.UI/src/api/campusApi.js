...
class CampusApi {
    ...
    static getAllSchools(schoolYear) {
        let serviceUrl = Config.REST_URL + "swav/odata/GetSchoolStatus(SchoolStartYear="+ schoolYear +")";
        return new Promise((resolve, reject) => {
            fetch( serviceUrl, { 
                method: "get",
                mode: 'cors',
    ...
    static getSchooolStatusAPI(schoolYear,schoolId) {
        let serviceUrl = Config.REST_URL + "swav/odata/GetSchoolStatus(SchoolStartYear="+schoolYear+")?$filter=(CampusNumber eq '"+schoolId+"')";
        return new Promise((resolve, reject) => {
            fetch( serviceUrl, { 
                method: "get",
                mode: 'cors',
    ...
    static getHighSchoolDetails(schoolYear) {
        let serviceUrl = Config.REST_URL + "swav/odata/GetSchoolNotStartedStatusWaivers(SchoolStartYear="+schoolYear+")?$filter=(High eq true and WaiverTypeID eq 1 and Deleted eq false)&$orderby=WaiverName asc";
        return new Promise((resolve, reject) => {
            fetch( serviceUrl, { 
                method: "get",
                mode: 'cors',
    ...
    static getElementarySchoolDetails(schoolYear) {
        let serviceUrl = Config.REST_URL + "swav/odata/GetSchoolNotStartedStatusWaivers(SchoolStartYear="+schoolYear+")?$filter=(Elementary eq true and WaiverTypeID eq 1 and Deleted eq false)&$orderby=WaiverName asc"; 
        return new Promise((resolve, reject) => {
            fetch( serviceUrl, { 
                method: "get",
                mode: 'cors',
    ...
    static getMiddleSchoolDetails(schoolYear) {
        let serviceUrl = Config.REST_URL + "swav/odata/GetSchoolNotStartedStatusWaivers(SchoolStartYear="+schoolYear+")?$filter=(Middle eq true and WaiverTypeID eq 1 and Deleted eq false)&$orderby=WaiverName asc";
        return new Promise((resolve, reject) => {
            fetch( serviceUrl, { 
                method: "get",
                mode: 'cors',
    ...
    static getSavedWaiver(schoolId,schoolYear) {
        let serviceUrl = Config.REST_URL + "swav/odata/GetSchoolStatusWaivers(SchoolStartYear='"+schoolYear+"')?$filter=(CampusNumber eq '"+schoolId+"' and SchoolWaiverDeleted eq false)";
        return new Promise((resolve, reject) => {
            fetch( serviceUrl, { 
                method: "get",
                mode: 'cors',
    ...
    static updateWaiversAPI(payload) {
        let serviceUrl = Config.REST_URL + "swav/odata/UpdateSchoolWaivers";
        return new Promise((resolve, reject) => {
            fetch(serviceUrl, { 
                method: "PATCH",
                mode: 'cors',
    ...
    static addWaiversAPI(payload) {
        let serviceUrl = Config.REST_URL + "swav/odata/AddSchoolWaivers";
        return new Promise((resolve, reject) => {
            fetch(serviceUrl, { 
                method: "POST",
                mode: 'cors',
    ...
    static addCustomWaiverAPI(payload) {
        let serviceUrl = Config.REST_URL + "swav/odata/AddCustomWaiver";
        return new Promise((resolve, reject) => {
            fetch(serviceUrl, { 
                method: "POST",
                mode: 'cors',
    ...
    static updatedCustomWaiverAPI(payload,ID) {
        let serviceUrl = Config.REST_URL + "swav/odata/Waivers("+ID+")";
        return new Promise((resolve, reject) => {
            fetch(serviceUrl, { 
                method: "PATCH",
                mode: 'cors',
    ...
    static getAllWaiverRequestsAPI(schoolYear) {
        let serviceUrl = Config.REST_URL + "swav/odata/GetWaiverRequestSchools(SchoolStartYear="+schoolYear+")";
        return new Promise((resolve, reject) => {
            fetch( serviceUrl, { 
                method: "get",
                mode: 'cors',
    ...
    static getRequestsFormAPI(schoolYear, campusNumber) {
        let serviceUrl = Config.REST_URL + "swav/odata/GetWaiverRequestDetail(SchoolStartYear="+schoolYear+")?$filter=CampusNumber eq '"+campusNumber+"'";
        return new Promise((resolve, reject) => {
            fetch( serviceUrl, { 
                method: "get",
                mode: 'cors',
    ...
    static updateRequestFormAPI(data) {
        ...
        let serviceUrl = Config.REST_URL + "swav/odata/WaiverRequestDetails("+requestID+")";
        const payload = {
    ...
    static getAddRequestDetailsAPI(schoolYear, campusNumber) {
        let serviceUrl = Config.REST_URL + "swav/odata/GetSchoolStatusWaivers(SchoolStartYear="+schoolYear+")?$filter=(CampusNumber eq '"+campusNumber+"' and SchoolWaiverDeleted eq false and WaiverRequestDetailStatus eq true)&$orderby=WaiverName asc";
        return new Promise((resolve, reject) => {
            fetch( serviceUrl, { 
                method: "get",
                mode: 'cors',
    ...
    static submitWaiverRequestAPI(payload) {
        let serviceUrl = Config.REST_URL + "swav/odata/AddWaiverRequestDetailsForm";
        return new Promise((resolve, reject) => {
            fetch(serviceUrl, { 
                method: "POST",
                mode: 'cors',
    ...
    static resetSchoolWaivers(startYear, campusNumber){
        let serviceUrl = Config.REST_URL + "swav/odata/ResetSchoolWaivers(SchoolStartYear="+startYear+",CampusNumber='"+campusNumber+"')";
        return new Promise((resolve, reject) => {
            fetch(serviceUrl, { 
                method: "DELETE",
                mode: 'cors',
    ...
    static finalizeWaiverRequestAPI(campusNumber,startYear) {
        let serviceUrl = Config.REST_URL + "swav/odata/FinalizeSchoolWaivers(SchoolStartYear="+startYear+",CampusNumber='"+campusNumber+"')";
        const payload = {
            WaiverStatusID : 3
        }
        return new Promise((resolve, reject) => {
    ...
    static getCustomWaiversAPI(campusNumber,year) {
        let serviceUrl = Config.REST_URL + "swav/odata/GetSchoolStatusWaivers(SchoolStartYear="+year+")?$filter=(CampusNumber eq '"+campusNumber+"' and SchoolWaiverDeleted eq false and WaiverTypeID eq 2)&$orderby=WaiverName asc";       
        return new Promise((resolve, reject) => {
            fetch( serviceUrl, { 
                method: "get",
                mode: 'cors',
    ...
    static addSDMCDetailsAPI(campusNumber, data){
        let serviceUrl = Config.REST_URL + "swav/odata/SDMC";
        const payload = {
