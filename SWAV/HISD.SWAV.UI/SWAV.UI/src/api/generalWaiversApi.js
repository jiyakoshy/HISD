...
class generalWaiversApi {
    static getGeneralWaivers(startYear) {
        let serviceUrl = Config.REST_URL + "swav/odata/GetGeneralWaivers(SchoolStartYear="+startYear+")";
    ...
    static deleteGeneralWaivers(waiverID) {
        let serviceUrl = Config.REST_URL + "swav/odata/WaiverAdministrations("+waiverID+")";
        const payload = {
    ...
    static addGeneralWaivers(payload) {
        let serviceUrl = Config.REST_URL + "swav/odata/Waivers";
        return new Promise((resolve, reject) => {
            fetch(serviceUrl, { 
                method: "POST",
                mode: 'cors',
