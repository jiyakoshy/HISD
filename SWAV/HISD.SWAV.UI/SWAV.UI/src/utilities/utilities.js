...
class Utilities {
    ...
    static sendEmailTemplate(data, comment, loginId){
        ...
        return {
            to: 'P00126358@houstonisd.org,SPENDEKA@houstonisd.org', //This is for only testing....
            //to : loginId+'@houstonisd.org',   //This is for Production.....
            subject: 'SWAV: The Custom Waiver has been Rejected.',
    ...
    static sendApprovalEmailTemplate(data, loginId){
        ...
        return {
            to: 'P00126358@houstonisd.org,SPENDEKA@houstonisd.org', //This is for only testing....
            //to : loginId+'@houstonisd.org',   //This is for Production.....
            subject: 'SWAV: The Custom Waiver has been Approved.',
    ...
    static sendSubmittedEmailTemplate(campusName, emailID){
        return {
            ...
            subject: 'SWAV: The Waivers has been Submitted.',
