namespace HisdAPI.Entities
{
    ...
    [Table("EXT.StudentLOGRAMOSGiftedTalentedAssessment")]
    public partial class StudentLOGRAMOSGiftedTalentedAssessment
    {
        [Key]
        [Column(Order = 0)]
        [StringLength(100)]
        public string StuLOGRGTAssetNaturalKey { get; set; }
