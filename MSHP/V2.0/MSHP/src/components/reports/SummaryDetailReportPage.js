...
class SummaryDetailReportPage extends React.Component {
    ...
    onSchoolYearDropdownChanged(evt){
        ...
        this.props.actions.loadsummaryReports(evt.target.value, this.state.reportDate);
        this.props.actions.loadsummarydetailReports(evt.target.value,this.state.reportDate);
    }
                        ...
                        <div className="col-md-12 col-lg-12 col-sm-12">
                            <div className="white-box">
                             ...
                             <label>School Year:&nbsp;&nbsp;<b><select id="schoolyear" value={this.state.schoolYear} onChange={this.onSchoolYearDropdownChanged}>
                              ...
                              <br/> <br/>
                              <BootstrapTable data={this.props.summaryreport} 
                                searchPlaceholder= {"Search"} striped hover condensed search exportCSV>
                                <TableHeaderColumn row="0" colSpan="1" dataSort csvHeader="Level" headerAlign="center">&nbsp;</TableHeaderColumn>
                                <TableHeaderColumn width="120px" row="1" dataField="LevelGroup" isKey dataSort>LevelGroup</TableHeaderColumn>
                              ...
                              <BootstrapTable 
                               ...
                               data={this.props.summarydetailreport} 
                               options={options}
                                searchPlaceholder= {"Search"} pagination striped hover condensed search exportCSV>
...
function mapDispatchToProps(dispatch) {
    return { actions: bindActionCreators(Object.assign({}, ajaxActions, campusActions,nonReportSchoolActions, summaryreportActions, summarydetailreportActions, enrollmentActions ,sharedActions), dispatch) };
}
