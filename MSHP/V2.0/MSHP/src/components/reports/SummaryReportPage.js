...
function mapDispatchToProps(dispatch) {
    return { actions: bindActionCreators(Object.assign({}, campusActions, nonReportSchoolActions,summaryreportActions, enrollmentActions,sharedActions,ajaxActions), dispatch) };
}
