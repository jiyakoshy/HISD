<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestGetSummaryReport.aspx.cs" Inherits="Mshp.Service.Reports.TestGetSummaryReport" %>
...
<head runat="server">
    <title>TestGetSummaryReport</title>
</head>
<body style="border:0;margin:0;Width:auto;">
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="DetailObjectDataSource" runat="server"            
            SelectMethod="GetSummaryDataSet" 
        ...
        <rsweb:ReportViewer ID="Rv1" runat="server" ClientIDMode="AutoID"             
            ...
            <localreport reportpath="Reports\Definition\Summary.rdlc">
                <datasources>
