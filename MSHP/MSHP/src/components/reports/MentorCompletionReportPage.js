...
class MentorCompletionReportPage extends React.Component {
    ...
    componentDidMount(){
        ...
        if(this.props.userProps.user.role == 'Admin'){
            ...
            if(this.props.userProps.user.role == 'Principal' || this.props.userProps.user.role == 'CIC'){
                ...
                this.setState({schoolMentors: schoolMentors, mentorEmployeeID: this.props.userProps.user.employeeID, isMenteeDropdownDisabled: false});
            }
        }
        hasMounted = true;
    }
    ...
    onMentorDropdownChanged(item) {
        ...
        .then(mentees => {
            this.setState({schoolMentees: teacherFormattedForDropdown(this.props.mentees)});
        });
    }
            ...
            <IfAnyGranted expected={['Admin','Principal', 'CIC', 'Mentor']} actual={this.props.userProps.user.role} unauthorized={<ErrorPage />}>
                <div id="page-wrapper">
                    <div className="container-fluid">
                        <PageHeader title="Mentor Completion Report" campus={this.props.campusName} />
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-12 col-lg-12 col-sm-12">
                                <div className="white-box">
                                    ...
                                    <TableHeaderColumn dataField="Month" dataSort dataAlign="center" width={"100px"} thStyle={{whiteSpace: 'normal', wordWrap: 'break-word'}}>Month</TableHeaderColumn>
                                    <TableHeaderColumn dataField="LogEntryCount" dataSort dataAlign="center" width={"100px"} tdStyle={{whiteSpace: 'normal', wordWrap: 'break-word'}} thStyle={{whiteSpace: 'normal', wordWrap: 'break-word', maxHeight: '20px'}}>Log Entry Count</TableHeaderColumn>
                                    </BootstrapTable>
                                </div>
                            </div>
                        </div>
