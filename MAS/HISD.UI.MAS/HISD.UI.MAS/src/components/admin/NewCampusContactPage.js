        ...
        savePromise.
            then((response) => {
                let sendEmail = this.props.actions.sendEmailCIC({
                    "Body": "You are added as new CIC in MAS",
                   // "To": this.state.employeeEmail,
                    "To": "P00126358@houstonisd.org",//"P00126549@houstonisd.org,P00126358@houstonisd.org,VBOLAGAM@houstonisd.org",
                    "Subject": "New CIC added"
                });
                sendEmail.
