...
class ActivityLogsMenteePage extends React.Component {
    ...
    componentDidMount() {
        ...
        this.props.actions.loadActivityLogsByMenteeID(this.props.userProps.user.staffNaturalKey, this.props.userProps.timeConfigurationID)
            .then(activityLogsMentee => {
                hasMounted = true;
            })
            .catch(reason => {
                        ...
                        <div className="row">
                            <div className="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div className="white-box">
                                    <BootstrapTable data={this.props.activityLogsMentee} hover condensed pagination options={options} search>
                                        <TableHeaderColumn dataField="ActivityLogMenteeID" isKey dataAlign="left" width={"100px"} dataFormat={this.linkFormatter}>View/Action</TableHeaderColumn>
                                        <TableHeaderColumn dataField="MenteeName" dataAlign="left" width={"100px"} tdStyle={{ whiteSpace: 'normal', wordWrap: 'break-word' }}>Mentee Name</TableHeaderColumn>
                                        <TableHeaderColumn dataField="MentorName" dataSort dataAlign="left" width={"100px"} tdStyle={{ whiteSpace: 'normal', wordWrap: 'break-word' }}>Mentor Name</TableHeaderColumn>
                                        ...
                                        <TableHeaderColumn dataField="VerificationCommentCode" dataSort dataAlign="left" width={"200px"} tdStyle={{ whiteSpace: 'normal', wordWrap: 'break-word' }} thStyle={{ whiteSpace: 'normal', wordWrap: 'break-word', maxHeight: '20px' }}>Not Verifying Reason</TableHeaderColumn>
                                        <TableHeaderColumn dataField="MenteeComments" dataSort dataAlign="left" width={"300px"} tdStyle={{ whiteSpace: 'normal', wordWrap: 'break-word' }} thStyle={{ whiteSpace: 'normal', wordWrap: 'break-word', maxHeight: '20px' }}>Mentee Comments</TableHeaderColumn>
...
ActivityLogsMenteePage.propTypes = {
    ...
    activityLogsMentee: PropTypes.array,
...
function mapStateToProps(state, ownProps) {
    return {
        ...
        activityLogsMentee: state.activityLogsMentee,
