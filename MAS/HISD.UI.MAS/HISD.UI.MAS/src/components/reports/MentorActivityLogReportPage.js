...
class MentorActivityLogReportPage extends React.Component {
    ...
    runReport(){
        if(this.isValidForm() == true){
            ...
            this.props.actions.clearReportData();
            let params = { StartDate: Utilities.getODataDate(this.state.reportStartDate), 
                EndDate: Utilities.getODataDate23hours(this.state.reportEndDate), 
                SchoolID: this.state.schoolID, 
                MentorEmployeeID: this.state.mentorEmployeeID, MenteeEmployeeID:this.state.menteeEmployeeID};
            this.props.actions.loadMentorActivityLogReport(params)
            .then(reportData => this.loadMentorActivityReportJSON());
        }
    }

    // process the reportdata into single array 
    loadMentorActivityReportJSON(){
            let mentorSessions = [];
            if(this.props.reportData != ""){
                //loop over each row
                    ...
                    //this.setState({mentorActivitiesSummary: mentorSessions});
                }
            this.setState({mentorActivitiesSummary: mentorSessions});
    }
    ...
    /*OLD: onMentorDropdownChanged(item) {
            ...
            <IfAnyGranted expected={['Admin','Principal', 'CIC', 'Mentor']} actual={this.props.userProps.user.role} unauthorized={<ErrorPage />}>
                <div id="page-wrapper">
                    <div className="container-fluid">
                        <PageHeader title="Mentor Activity Log Report" campus={this.props.campusName} hideCampusDrpDwn="Hide"/>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-12 col-lg-12 col-sm-12">
                                <div className="white-box">
                                    ...
                                    <BootstrapTable data={this.state.mentorActivitiesSummary} hover condensed pagination options={options} search exportCSV>
                                        ...
                                        <TableHeaderColumn dataField="ActivityCodeName" datasort dataAlign="left" width={"100px"}>Activity</TableHeaderColumn>
                                        <TableHeaderColumn dataField="Duration" dataSort dataAlign="center" width={"100px"}  thStyle={{whiteSpace: 'normal', wordWrap: 'break-word'}}>Duration (mins)</TableHeaderColumn>
