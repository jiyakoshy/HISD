...
class CandidateSearchCampusesApi {
    ...
    static loadCandidatesByEmpID(departmentID, employeeID) {
        let serviceUrl = Config.REST_URL + "common/odata/EducationOrganizations('" + departmentID + "')?$expand=Staffs($filter=EmployeeNumber eq '" + employeeID + "' and StaffActiveIndicator eq true  and SalaryPlanTypeNaturalKey ne 'CON' ) ";
    ...
    static loadCandidatesByEmpName(departmentID, employeeName) {
        let serviceUrl = Config.REST_URL + "common/odata/EducationOrganizations('" + departmentID + "')?$expand=Staffs($filter=(FirstName eq '" + employeeName + "' or LastSurname eq '" + employeeName + "' or MiddleName eq '" + employeeName + "') and StaffActiveIndicator eq true  and SalaryPlanTypeNaturalKey ne 'CON' ) ";
        return new Promise((resolve, reject) => {
            fetch(serviceUrl, {
                method: "get",
                mode: 'cors',
