    ...
    return function (dispatch) {
        ...
        return CandidateSearchCOApi.loadCandidatesByEmpName(employeeName).then(candidateSearchCORes => {
            if (candidateSearchCORes.value.length > 0) {
               /*  console.log('candidateSearchCORes.value------',candidateSearchCORes.value); */
               ...
               /*  console.log('candidateSearchCO------',candidateSearchCO); */
                let QueryStaffID = '';
                ...
                if (StaffsCount > 0) {
                    ...
                    QueryArrayStaffID.push(QueryStaffID);
                   /*  console.log('QueryArrayStaffID------',QueryArrayStaffID); */
                    ...
                    if (QueryArrayStaffID.length > 0) {
                        ...
                        return Promise.all(NewArrayPayGrades).then(function () {
                            if (PayGradeArray.length > 0) {
                               ...
                               /*  console.log('candidateSearchCOFiltered------',candidateSearchCOFiltered); */
                                if (candidateSearchCOFiltered.length > 0) {
                                   ...
                                   /*  console.log('CandidateSearchGrid------',CandidateSearchGrid); */
