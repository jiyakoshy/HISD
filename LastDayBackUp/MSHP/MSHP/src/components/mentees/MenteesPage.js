...
this.props.actions.loadMenteesByCampus(this.props.userProps.user.campusID);
    ...
    render() {
        if(this.state.campusID != this.props.campusID){
            this.props.actions.loadMenteesByCampus(this.props.campusID);
            this.setState({campusID: this.props.campusID});
        }
        const options = {
                        ...
                        <div className="col-md-12 col-lg-12 col-sm-12">
                            ...
                            <div className="white-box">
                                <BootstrapTable data={this.props.mentees} hover condensed pagination options={options} search>
                                    <TableHeaderColumn dataField="StaffNaturalKey" isKey dataAlign="left" width={"100px"}>Emp. ID</TableHeaderColumn>
...
function mapDispatchToProps(dispatch) {
    return { actions: bindActionCreators(Object.assign({}, campusActions, menteesActions), dispatch) };
}
