            ...
            <IfAnyGranted expected={['Admin','Principal', 'CIC']} actual={this.props.userProps.user.role} unauthorized={<ErrorPage />}>
                <div id="page-wrapper">
                    <div className="container-fluid">
                        <PageHeader title="Verification Standards and Tools Report" campus={this.props.campusName} />
                            ...
                            <div className="col-md-12 col-lg-12 col-sm-12">
                                <div className="white-box">
                                    ...
                                    <BootstrapTable data={this.props.reportData} hover condensed pagination options={options} search exportCSV>
                                        ...
                                        <TableHeaderColumn dataField="ActivityStartTime" dataSort dataAlign="left" width={"100px"} dataFormat={this.dateFormatter} thStyle={{whiteSpace: 'normal', wordWrap: 'break-word'}}>Activity Date and Time</TableHeaderColumn>
                                        ...
                                        <TableHeaderColumn dataField="Duration" dataSort dataAlign="center" width={"100px"} dataFormat={this.dateFormatter} thStyle={{whiteSpace: 'normal', wordWrap: 'break-word', textAlign: 'center'}}>Duration (mins)</TableHeaderColumn>
