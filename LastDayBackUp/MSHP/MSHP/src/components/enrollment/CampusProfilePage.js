...
class CampusProfilePage extends React.Component {
    ...
    clearFormState() {
        ...
        //updatedProfileForm.insertedPK = 0;
    ...
    editInputs(e) {
        ...
        console.log('the iv value is', iv);
        console.log('the e.target.id is', inputIdentifier);
    ...
    onCampusDropdownChanged(item) {
        ...
        if (this.state.selectedYear !== ''){
            ...
            this.props.actions.loadCampusProfile(item.key, this.state.selectedYear).then(
                campusProfile => {
                    console.log('this.props.campusProfile----', this.props.campusProfile);
                    this.setState(
                        {
    ...
    onYearsDropdownChanged(item) {
        ...
        console.log('YEARS KEY ----------------- ', item.key);
    ...
    onSavingSucceeds() {
        ...
        /* this.props.actions.loadCampusProfile(this.state.schoolID, this.state.selectedYear).then(
            campusProfile => {
                console.log('onsavingSucceeds...this.props.campusProfile----', this.props.campusProfile);
                this.setState(
                    {
                        capacity: this.props.campusProfile.capacity,
                        projection: this.props.campusProfile.projection,
    ...
    handleFormSubmit(e) {
        ...
        console.log('saved within handleFormSubmit');
                    ...
                    <div className="container-fluid">
                        <div className="row bg-title">
                            <div className="col-lg-12 col-md-12 col-sm-12 ">
                                <span className="page-title-custom">School Profile</span>
                                {campusDDAdmin}
                                {campusDD}
                            </div>
                        </div>
