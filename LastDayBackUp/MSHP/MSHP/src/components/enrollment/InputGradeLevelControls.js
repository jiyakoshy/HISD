...
class InputGradeLevelControls extends React.Component {
    constructor(props) {
        ...
        this.state = {
           ...
           //gradeLevel: this.props.inputGradeLevelData.gradeLevel.length > 2 ? this.props.inputGradeLevelData.gradeLevel.substring(1,3) : this.props.inputGradeLevelData.gradeLevel,
           //gradeLevel: this.props.inputGradeLevelData.gradeLevel,
    ...
    componentDidUpdate(prevProps){
        //if (this.props !== prevProps) this.buildJSX();
    }
    

    render(){
        console.log('just entered render() of Inside InputGrade LevelControls');
        ...
        console.log('this.props.inputGradeLevelData.gradeLevel----------------- ',this.props.inputGradeLevelData.gradeLevel);
//        console.log('just entered render() of Inside InputGrade LevelControls ---- valAsString ------- ', valAsString);
        console.log('just entered render() of Inside InputGrade LevelControls ---- props.passValue ------- ', this.props.passValue);
        ...
        //console.log('just entered render() of Inside InputGrade LevelControls ----- GL ----- ',this.state.gradeLevel) ;
        console.log('just entered render() of Inside InputGrade LevelControls----- ID ----- ',this.state.id);
        
        //below gradeLevel is trimmed from 01 to 1, 02 to 2, etc. so that User recognizes it as the grade level
        let counts = null;
        let isReadOnly = true;
...
/* function mapStateToProps(state, ownProps) {
    return {
        ...
        inputGradeLevelData: state.inputGradeLevelData,
        id: state.id
