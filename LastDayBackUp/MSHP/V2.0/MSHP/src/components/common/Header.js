            ...
            <nav className="navbar navbar-default navbar-static-top" style={styleNav}>
                <div className="navbar-header"> <a className="navbar-toggle hidden-lg hidden-md hidden-sm" href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i className="ti-menu"></i></a>
                    <div className="top-left-part">
                        <a className="hidden-xs" href="https://connectdevapps.houstonisd.org/SitePages/Home.aspx" title="Back to Site"><i className="icon-home fa-fw"></i></a>
                        <a className="page-title" href="https://connectdevapps.houstonisd.org/SitePages/Home.aspx">MSHP</a>
                    </div>
...
function mapDispatchToProps(dispatch) {
    return { actions: bindActionCreators(Object.assign({}, sharedActions, campusActions, enrollmentActions, enrollmentInputActions), dispatch) };
}
