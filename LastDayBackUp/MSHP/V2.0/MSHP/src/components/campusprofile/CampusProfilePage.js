...
class CampusProfilePage extends React.Component {
    ...
    componentDidMount() {
       const schoolYearEnd = Utilities.getSchoolYearEnd(this.props.schoolYear);
    }
            ...
            <IfAnyGranted expected={['Admin', 'Campus']} actual={this.props.userProps.user.role} unauthorized={<ErrorPage />}>
                ...
                <div id="page-wrapper">
                    <div className="container-fluid">
                        <PageHeader title="School Profile" campus={this.props.campusName} />
                        <div className="row">
                                ...
                                <div>
                                    ...
                                    <div className="row" style={{ 'marginBottom': '15px', 'marginTop': '8px' }}>
                                        ...
                                        <div className=" col-md-4 col-lg-4 col-sm-4">
                                            ...
                                            onChanged={this.onYearsDropdownChanged} /> </div>
                                        <div className=" col-md-4 col-lg-4 col-sm-4">
                                        </div>
                                    </div>
                                    <div className="row" style={{ 'marginBottom': '15px', 'marginTop': '8px' }}>
                                    ...
                                    <div className="row" style={{ 'marginBottom': '15px', 'marginTop': '8px' }}>
                                        ...
                                        <label className="col-md-2 col-lg-2 col-sm-2">Organization Group:</label>
                                        <label className=" col-md-4 col-lg-4 col-sm-4">
...
function mapDispatchToProps(dispatch) {
    return { actions: bindActionCreators(Object.assign({}, nonReportSchoolActions, calendarReportDatesActions, sharedActions, ajaxActions, enrollmentActions, gradeLevelsActions, campusActions), dispatch) };
}
