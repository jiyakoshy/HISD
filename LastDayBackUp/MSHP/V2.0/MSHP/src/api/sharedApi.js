...
class SharedApi {
                ...
                menuOptions = [
                    ...
                    { name: 'Admin', key: 'Admin', url: '#', icon: 'Add',
                        links:  [ 
                            ...
                            // { name: 'Organization Group', key: 'organizationgroup', url: '#organizationgroup', icon: 'Add' }
                                ],
                            isExpanded: true
                    },
    ...
    static getSchoolYearType() {
        let serviceUrl = Config.REST_URL + "common/odata/SchoolYearTypes";
        return new Promise((resolve, reject) => {
            fetch(serviceUrl, {
                method: "get",
                mode: 'cors',
