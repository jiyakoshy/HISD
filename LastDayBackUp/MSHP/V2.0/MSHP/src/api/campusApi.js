...
class CampusApi {
    ...
    static getAllCSOs() {
        let serviceUrl = Config.REST_URL + "common/odata/EducationOrganizations?$expand=SchoolManagers($expand=Up2Manager)";
        const parameters = {
            method: 'get',
            mode: 'cors',
            cache: 'no-cache',
    ...
    static getGradeLevelsByCampusCurrentYear(campusID, schoolYear) {
        const schoolYearEnd = schoolYear;
    ...
    static getCampusTypeByCampus(campusID) {
        let serviceUrl = Config.REST_URL + "common/odata/CampusType(CampusID = '" + campusID + "')";
        const parameters = {
            method: 'get',
            mode: 'cors',
            cache: 'no-cache',
