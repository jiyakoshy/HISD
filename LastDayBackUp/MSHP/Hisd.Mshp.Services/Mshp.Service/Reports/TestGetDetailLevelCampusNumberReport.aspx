<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestGetDetailLevelCampusNumberReport.aspx.cs" Inherits="Mshp.Service.Reports.TestGetDetailLevelCampusNumberReport" %>
...
<head runat="server">
    <title>TestGetDetailLevelCampusNumberReport</title>
</head>
<body style="border:0;margin:0;Width:auto;">
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="DetailObjectDataSource" runat="server"            
            SelectMethod="GetDetailLevelCampusNumberDataSet" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter Name="CampusNumber" QueryStringField="CampusNumber" Type="String" />
            </SelectParameters>
