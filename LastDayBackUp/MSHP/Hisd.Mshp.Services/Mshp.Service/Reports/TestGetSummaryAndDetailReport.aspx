<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestGetSummaryAndDetailReport.aspx.cs" Inherits="Mshp.Service.Reports.TestGetSummaryAndDetailReport" %>
...
<body style="border:0;margin:0;Width:auto;">
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="DetailObjectDataSource" runat="server"            
            SelectMethod="GetSummaryAndDetailDataSet" 
        ...
        <rsweb:ReportViewer ID="Rv1" runat="server" ClientIDMode="AutoID"             
            ...
            <localreport reportpath="Reports\Definition\SummaryAndDetail.rdlc">
                <datasources>
