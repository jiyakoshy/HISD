<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestGetDetailLevelOrganizationGroupIdReport.aspx.cs" Inherits="Mshp.Service.Reports.TestGetDetailLevelOrganizationGroupIdReport" %>
...
<head runat="server">
    <title>TestGetDetailLevelOrganizationGroupIdReport</title>
</head>
<body style="border:0;margin:0;Width:auto;">
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="DetailObjectDataSource" runat="server"            
            SelectMethod="GetDetailLevelOrganizationGroupIdDataSet" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter Name="OrganizationGroupId" QueryStringField="OrganizationGroupId" Type="Int32" />
            </SelectParameters>
