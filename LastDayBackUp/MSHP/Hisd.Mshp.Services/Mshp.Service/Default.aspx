...
<body style="background:top right url(Resources/Media/hisd_seal.gif) no-repeat #f2f4ee;font-size:larger;" >
    <form id="form1" runat="server">
        ...
        <div style="display:normal;">
            ...
            odata/GetEnrollmentDataByCampus(SchoolYear='2017-2018',CampusNumber='104')  <i style="color:red;">[IMPORTANT!]</i><br />
            odata/GetAnnualSetupDataByCampus(SchoolYear='2017-2018')  <i style="color:red;">[IMPORTANT!]</i><br />
            ...
            <br />
            odata/GetCSOSummaryReport(SchoolYear='2017-2018',CompareDaySeq=22) <br />
            <hr />
