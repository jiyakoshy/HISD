...
namespace HISD.MAS.Web.Controllers
{
    public class MentorMenteeRelationshipsController : ODataController
    {
        ...
        // GET: odata/ GetMentorMenteeRelationshipsByTimeConfig
        [HttpGet]
        [EnableQuery]
        [ODataRoute("GetMentorMenteeRelationshipsByTimeConfig(TimeConfigurationID={timeConfigID})")]      //,TimeConfigurationID={timeConfigID}
        public IQueryable<MentorMenteeRelationship> GetMentorMenteeRelationshipsByTimeConfig([FromODataUri] int timeConfigID)
        {
            return db.MentorMenteeRelationships
                .Where(a => a.TimeConfigurationID == timeConfigID);
        }
        // GET: odata/ GetMentorMenteeRelationshipsByCampusIDTimeConfig
        [HttpGet]
        [EnableQuery]
        [ODataRoute("GetMentorMenteeRelationshipsByCampusIDTimeConfig(CampusID={campusID},TimeConfigurationID={timeConfigID})")]      //,TimeConfigurationID={timeConfigID}
        public IQueryable<MentorMenteeRelationship> GetMentorMenteeRelationshipsByCampusIDTimeConfig([FromODataUri] string campusID, [FromODataUri] int timeConfigID)
        {
            return db.MentorMenteeRelationships
                .Where(a => a.TimeConfigurationID == timeConfigID && a.CampusID == campusID);
        }
        // GET: odata/ GetMentorMenteeRelationshipsByMenteeID
        [HttpGet]
        [EnableQuery]
        [ODataRoute("GetMentorMenteeRelationshipsByMenteeID(MenteeID={menteeID})")]      //,TimeConfigurationID={timeConfigID}
        public IQueryable<MentorMenteeRelationship> GetMentorMenteeRelationshipsByMenteeID([FromODataUri] string menteeID)
        {
            return db.MentorMenteeRelationships
                .Where(a => a.MenteeEmployeeID == menteeID);
        }

        // GET: odata/ GetMentorMenteeRelationshipsBetweenCreatedDates
        [HttpGet]
        [EnableQuery]
        [ODataRoute("GetMentorMenteeRelationshipsBetweenCreatedDates(StartDate={startDate},EndDate={endDate})")]      //,TimeConfigurationID={timeConfigID}
        public IQueryable<MentorMenteeRelationship> GetMentorMenteeRelationshipsBetweenCreatedDates([FromODataUri] string startDate, [FromODataUri] string endDate)
        {
            DateTime fromDate = Convert.ToDateTime(startDate);
            DateTime toDate = Convert.ToDateTime(endDate);
            return db.MentorMenteeRelationships
                .Where(a => a.CreateDate > fromDate && a.CreateDate < toDate);
        }
