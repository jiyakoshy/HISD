...
namespace HISD.MAS.Web
{
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            var GetMentorMenteeRelationshipsByTimeConfig = builder.Function("GetMentorMenteeRelationshipsByTimeConfig");
            GetMentorMenteeRelationshipsByTimeConfig.Parameter<int>("TimeConfigurationID");
            GetMentorMenteeRelationshipsByTimeConfig.ReturnsCollectionFromEntitySet<MentorMenteeRelationship>("MentorMenteeRelationshipsByTimeConfig");

            var GetMentorMenteeRelationshipsByCampusIDTimeConfig = builder.Function("GetMentorMenteeRelationshipsByCampusIDTimeConfig");
            GetMentorMenteeRelationshipsByCampusIDTimeConfig.Parameter<int>("TimeConfigurationID");
            GetMentorMenteeRelationshipsByCampusIDTimeConfig.Parameter<string>("CampusID");
            GetMentorMenteeRelationshipsByCampusIDTimeConfig.ReturnsCollectionFromEntitySet<MentorMenteeRelationship>("MentorMenteeRelationshipsByCampusIDTimeConfig");

            var GetMentorMenteeRelationshipsByMenteeID = builder.Function("GetMentorMenteeRelationshipsByMenteeID");
            GetMentorMenteeRelationshipsByMenteeID.Parameter<string>("MenteeID");
            GetMentorMenteeRelationshipsByMenteeID.ReturnsCollectionFromEntitySet<MentorMenteeRelationship>("MentorMenteeRelationshipsByMenteeID");

            var GetMentorMenteeRelationshipsBetweenCreatedDates = builder.Function("GetMentorMenteeRelationshipsBetweenCreatedDates");
            GetMentorMenteeRelationshipsBetweenCreatedDates.Parameter<string>("StartDate");
            GetMentorMenteeRelationshipsBetweenCreatedDates.Parameter<string>("EndDate");
            GetMentorMenteeRelationshipsBetweenCreatedDates.ReturnsCollectionFromEntitySet<MentorMenteeRelationship>("MentorMenteeRelationshipsBetweenCreatedDates");
            ...
            builder.Function("GetAllCampusContacts")
                .ReturnsCollectionFromEntitySet<CampusContact>("CampusContacts")
                .Parameter<int>("TimeConfigurationID");
            ...
            var campusContactsByCampusID = builder.Function("GetCampusContactsByCampusID");
            campusContactsByCampusID.Parameter<string>("CampusID");
            campusContactsByCampusID.Parameter<int>("TimeConfigurationID");
            campusContactsByCampusID.ReturnsCollectionFromEntitySet<CampusContact>("CampusContactsByCampusID");
            ...
            ////     .Parameter<string>("CampusID");
            var mentorsInActiveRelationships = builder.Function("GetMentorsInActiveRelationshipByCampusID");
            mentorsInActiveRelationships.Parameter<string>("CampusID");
            mentorsInActiveRelationships.Parameter<int>("TimeConfigurationID");
            mentorsInActiveRelationships.ReturnsCollectionFromEntitySet<MentorMenteeRelationship>("MentorsInActiveRelationshipByCampusID");
            ...
            ////     .Parameter<string>("CampusID");
            var menteesInActiveRelationships = builder.Function("GetMenteesInActiveRelationshipByCampusID");
            menteesInActiveRelationships.Parameter<string>("CampusID");
            menteesInActiveRelationships.Parameter<int>("TimeConfigurationID");
            menteesInActiveRelationships.ReturnsCollectionFromEntitySet<MentorMenteeRelationship>("MenteesInActiveRelationshipByCampusID");
            ...
            var menteesInActiveRelationshipsByMentor = builder.Function("GetMenteesInActiveRelationshipByMentorID");
            menteesInActiveRelationshipsByMentor.Parameter<string>("CampusID");
            menteesInActiveRelationshipsByMentor.Parameter<int>("TimeConfigurationID");
            menteesInActiveRelationshipsByMentor.Parameter<string>("EmployeeID");
            menteesInActiveRelationshipsByMentor.ReturnsCollectionFromEntitySet<MentorMenteeRelationship>("MenteesInActiveRelationshipByMentorID");


            //MPR New Method for GetAllActivityLogs
            var allActivityLogsByTimeConfig = builder.Function("GetAllActivityLogsByTimeConfig");
            allActivityLogsByTimeConfig.Parameter<int>("TimeConfigurationID");
            allActivityLogsByTimeConfig.ReturnsCollectionFromEntitySet<ActivityLogsByTimeConfig>("AllActivityLogsByTimeConfig");
