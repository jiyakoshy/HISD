...
class customWaiversApi {
    static getCustomWaivers(startYear) {
        let serviceUrl = Config.REST_URL + Config.SERVICESTART +"/odata/GetSchoolCustomWaivers(SchoolStartYear="+startYear+")?$filter=(WaiverStatusID eq 3)";
    ...
    static sendEmail(email){
        let serviceUrl = Config.REST_URL + Config.SERVICESTART +"/api/Email";
        return new Promise((resolve, reject) => {
            fetch(serviceUrl, { 
                method: "POST",
                mode: 'cors',
