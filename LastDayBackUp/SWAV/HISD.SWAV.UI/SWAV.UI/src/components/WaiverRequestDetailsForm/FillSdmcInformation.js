                ...
                <div className="form-group">
                    ...
                    <div>
                        <textarea id="sdmc-name" rows="1" className="form-control"
                         value={this.state.name} placeholder="Please enter the SDMC name.." onChange={this.onChangeName}></textarea>
                    </div>
                </div>
                <div className="form-group">
                    ...
                    <div>
                        <textarea id="sdmc-email" rows="1" value={this.state.email}
                         onChange={this.onChangeEmail} placeholder="Please enter the SDMC email.." className="form-control"></textarea>
                    </div>
                </div>
