        ...
        return (
            <div className="row">
                ...
                <div className="form-group" style={{marginLeft: '2%', marginRight: '2%'}}>
                    ...
                    <div>
                        <textarea value={this.state.waiverComment} placeholder="Please enter the comments.." id="waiverComment" onChange={this.onChangeWaiverComment} rows="4" className="form-control"></textarea>
                    </div>
                </div>
