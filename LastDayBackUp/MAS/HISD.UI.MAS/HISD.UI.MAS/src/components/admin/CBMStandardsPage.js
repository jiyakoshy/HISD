                        ...
                        <div className="row">
                            <div className="col-md-6 col-lg-6 col-sm-12">
                                ...
                                <BootstrapTable data={this.props.cbmStandards} hover condensed options={options}>
                                        ...
                                        <TableHeaderColumn dataField="NoOfDaysRemainingReminder" dataAlign="center">Number of Days Remaining for Remainder</TableHeaderColumn>
