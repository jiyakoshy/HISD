...
export function deleteNewActivityMenteeEditSuccess(employeeID) {
    return { type: types.NEW_DELETE_ACTIVITY_MENTEE_EDIT_SUCCESS, employeeID};
}

export function deleteNewActivityMenteeEdit(employeeID) {
    return function (dispatch) {
        return dispatch(deleteNewActivityMenteeEditSuccess(employeeID));
    };
}
